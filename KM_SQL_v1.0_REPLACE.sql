...
--
-- Serveur: localhost
-- Généré le : Ven 15 Mars 2013 à 17:15
...
REPLACE INTO `article` (`idArticle`, `idType`, `idUser`, `idCategorie`, `dt_creation`, `titre`, `article`) VALUES
...
REPLACE INTO `categorie` (`idCategorie`, `idPortail`, `categorie`, `description`) VALUES
...
REPLACE INTO `commentaire` (`idCommentaire`, `idArticle`, `idUser`, `idType`, `date_creation`, `titre`, `commentaire`) VALUES
...
REPLACE INTO `favoris` (`idFavoris`, `idUser`, `idArticle`, `nbViews`, `isForced`) VALUES
(1, 1, 15, 195, 1),
(2, 1, 16, 78, 1),
(3, 1, 17, 30, 1),
(4, 1, 21, 8, 1),
...
REPLACE INTO `motcle` (`idMotCle`, `idArticle`, `motcle`) VALUES
(127, 16, 'popup'),
(128, 16, 'javascript'),
(134, 21, 'titre'),
(143, 22, 'test'),
...
REPLACE INTO `portail` (`idPortail`, `portail`) VALUES
(1, 'Informatique'),
(7, 'Histoire'),
(14, 'portail test');
...
REPLACE INTO `type` (`idType`, `type`) VALUES
(1, 'Article'),
(2, 'Cours');
...
REPLACE INTO `user` (`idUser`, `lstName`, `fstName`, `email`, `role`, `login`, `password`) VALUES
