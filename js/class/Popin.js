...
Popin.prototype = {
	...
	Action: {
		Show: function(t){
			...
			if(user.CheckUserAccess(lvl) || (t.s.type == "user" && Data.user.data.idUser == t.s.values.idUser)){
				$(".popin").remove();
	...
	UI: {
		...
		BuildTitle: function(t){
			...
			if((user.CheckUserAccess(lvl) || (t.s.type == "user" && Data.user.data.idUser == t.s.values.idUser)) && t.s.title != ""){
		...
		BuildCloseBtn: function(t){
			...
			if((user.CheckUserAccess(lvl) || (t.s.type == "user" && Data.user.data.idUser == t.s.values.idUser)) && t.s.addCloseBtn){
		...
		BuildContent: function(t){
			...
			if((user.CheckUserAccess(lvl) || (t.s.type == "user" && Data.user.data.idUser == t.s.values.idUser)) && t.s.content != "" || t.s.structure){
		...
		BuildLineForm: function(t, str){
			...
			if((user.CheckUserAccess(lvl) || (t.s.type == "user" && Data.user.data.idUser == t.s.values.idUser)) && str && str.key != null){
		...
		BuildCommand: function(t){
			...
			if((user.CheckUserAccess(lvl) || (t.s.type == "user" && Data.user.data.idUser == t.s.values.idUser)) && t.s.cmd.length){
				var btn = null;
