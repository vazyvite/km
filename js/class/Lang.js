var Lang = {
	...
	EN: {
		...
		msg: {
			...
			success_update_portail_title: "Successful update",
			success_update_portail_msg: "Portal update succeed",
			error_update_portail_title: "Failed update",
			error_update_portail_msg: "Portal update failed",
			success_delete_portail_title: "Successful deletion",
			success_delete_portail_msg: "Portail deletion succeed",
			error_delete_portail_title: "Failed deletion",
			error_delete_portail_msg: "Portal deletion failed",
			success_create_portail_title: "Successful creation",
			success_create_portail_msg: "Portal creation succeed",
			error_create_portail_title: "Fail creation",
			error_create_portail_msg: "Portail creation failed",
			error_no_portail_title: "No portal",
			error_no_portail_msg: "There is no existing portal",
		}
	}
}